...
def sankey(data):
    if not {'source', 'target', 'value'}.issubset(data.columns):
        st.error("The CSV file must contain 'source', 'target', and 'value' columns.")
        return None
...
def main():
    ...
    st.markdown("Visualize your budget data with an interactive Sankey diagram.")
